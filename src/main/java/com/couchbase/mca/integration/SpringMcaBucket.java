...
public class SpringMcaBucket implements Bucket {
  ...
  public SpringMcaBucket(MultiClusterClient multiClusterClient, String bucketName, CouchbaseEnvironment environment) {
    this.multiClusterBucket = multiClusterClient.openBucket(bucketName);
  ...
  public MultiClusterBucket getMultiClusterBucket() {
    return this.multiClusterBucket;
  }
